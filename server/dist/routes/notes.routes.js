...
function notesRoutes(app) {
    ...
    app.post("/api/notes/:id/shareWith", middlewares_1.middlewares.authJwt.verifyToken, controller.shareNoteWithUser);
    app.delete("/api/notes/:id/shareWith", middlewares_1.middlewares.authJwt.verifyToken, controller.unshareNoteWithUser);
    // app.post(
    //   "/api/notes/:id/rate",
